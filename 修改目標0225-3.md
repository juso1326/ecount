...
**問題：** openEditReceivableModal() 欄位 ID 需確認與 modal HTML 對應
**修改內容：**
- 確認 edit_receipt_date / edit_amount / edit_content / edit_due_date / edit_invoice_no / edit_note 與 modal 一致

---

## 6. 專案頁 - 應付帳款快速新增無效
**頁面：** https://abc123.ecount.test/projects/35
**檔案：** show.blade.php、ProjectController.php
**問題：** 送出後無新增成功（validation / qaCalcTax / payee_type）
**修改內容：**
- 確認 quickAddPayable() validation 規則
- 確認 qaCalcTax() JS 已定義
- 確認 payee_type 預設值與送出流程
