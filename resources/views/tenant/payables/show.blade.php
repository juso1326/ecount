...
<div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
    <div class="p-6">
        <!-- 基本資訊 -->
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 pb-2 border-b border-gray-200 dark:border-gray-700">
            基本資訊
        </h2>
        ...
        <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div>
                    ...
                    <p class="text-xs text-blue-600 dark:text-blue-400">= 應收金額 - 已收金額</p>
                </div>
                <div>
                    ...
                    <p class="text-xs text-blue-600 dark:text-blue-400">= 已收金額 - 扣繳稅額</p>
                </div>
            </div>
        </div>
