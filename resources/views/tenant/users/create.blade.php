...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <nav>
        <ol class="flex items-center gap-2">
            ...
            <li class="font-medium text-primary">新增</li>
        </ol>
    </nav>
</div>
            ...
            <form method="POST" action="{{ route('tenant.users.store') }}">
                ...
                <div class="p-6.5">
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        ...
                        <div class="w-full xl:w-1/2" id="supervisor_field" style="display: none;">
                            <label class="mb-2.5 block text-black dark:text-white">
                                上層主管
                            </label>
                ...
                <div class="p-6.5">
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        ...
                        <div class="w-full xl:w-1/2">
                            <label class="mb-2.5 block text-black dark:text-white">
                                密碼 <span class="text-meta-1">*</span>
                            </label>
                ...
                <div class="p-6.5">
                    <div class="mb-6">
                        ...
                        <textarea name="note" id="note" rows="4"
                            placeholder="請輸入備註內容"
                            class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">{{ old('note') }}</textarea>
                    </div>
