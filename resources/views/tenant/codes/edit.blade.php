...
@section('page-title', '編輯' . $categoryName)

@section('content')
<!-- 麵包屑 -->
<div class="mb-4">
    <p class="text-sm text-gray-600 dark:text-gray-400">專案帳戶管理 &gt; 代碼管理 &gt; {{ $categoryName }} &gt; 編輯</p>
</div>

<!-- 頁面標題 -->
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">編輯{{ $categoryName }}</h1>
</div>
    ...
    <form method="POST" action="{{ route('tenant.codes.update', [$category, $code]) }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="code" id="code" value="{{ old('code', $code->code) }}" required
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $code->name) }}" required
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $code->sort_order) }}" min="0" required
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="3"
                    class="mt-1 block w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description', $code->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
