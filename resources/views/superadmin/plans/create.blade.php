...
@section('title', '新增方案')
@section('page-title', '新增方案')

@section('content')
<div class="max-w-3xl">
    <form action="{{ route('superadmin.plans.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        @csrf
