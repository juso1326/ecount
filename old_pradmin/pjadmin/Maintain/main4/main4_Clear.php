...
<div id="wrapper">
	<div class="box-data">
             	<div class="input-Group">
                        <form id="form1" name="form1" method="post" action="main4_ClearNew.php">
                        	<input id="memm01_no" name="memm01_no" type="hidden" value="<?php echo $sMem;?>">
                                ...
                                <tr>
                                	...
                                	<td>
                                    	<table>
                                        	<tr>
                                            	<td><em>*</em>給付日</td>
                                            	<td><input id="foundt03_date" name="foundt03_date" class="datepicker" type="text" value="<?php echo date("Ym05",strtotime("+1 months",strtotime($sY . $sM . "05")));?>"></td>                                                
                                            </tr>
                                        	<tr>
                                            	<td>應付</td>
                                        	...
                                        	<tr>
                                            	<td>備註</td>
                                            	<td><textarea id="foundt03_remark" name="foundt03_remark" rows="2" cols="40"></textarea></td>
                                            </tr> 
                                            <tr>
                                            	<td></td>
                                                <td>
													<input id="payChk" class="blue" type="button" value="給付" onClick="ChkForm(form1)">								
                                                </td>
                                            </tr>
                                        </table>
                                    </td>                                    
