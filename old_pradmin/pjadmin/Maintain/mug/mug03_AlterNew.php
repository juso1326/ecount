...
//資料庫連線
	...
	if($initCount != 1){
		header('location:/pjadmin/Maintain/ERRORPAGE.php?GetFileCode=' . $GetFileCode . '&Error=' . '資料錯誤');
		exit();
	}
	$i = 0;
	...
	$where = " where 1 = 1 ";
	$where .= " and MUG03_NO = '$DataKey'";
	Update($NewSql,"mug_03",$RowArr,$Arr,$where);
