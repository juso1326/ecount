...
//參數
	...
	$firet02_no = xRequest("firet02_no");
...
//資料庫連線
	...
	switch(true){
		case ($firet02_no != ""):
			...
			$where = " where 1 = 1 ";
			$where .= " and firet02_no = '$firet02_no'";
			Update($NewSql,"fire_t02",$RowArr,$Arr,$where);
		...
		default:
			...
			//新增資料
			Insert($NewSql,"fire_t02",$RowArr,$Arr);		
			break;
	}	
