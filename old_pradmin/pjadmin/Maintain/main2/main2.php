...
//參數
	...
	$Sql = " 
		Select firmm01_no,firmm01_type1,firmm01_nm,firmm01_nicknm
		From fire_m01
		Order by firmm01_no 
	";
        ...
        <div class="box-content">
            <div class="box-head">
            	<ul class="btn">
                    ...
                    <li style="padding:0 10px;">
                    	第
						<select onChange="javascript:window.location='/pjadmin/Maintain/mug/mug01.php?page=' + this.value">
        	...
        	<table class="table-bordered">
            	...
            	<tr class="<?php echo ($i%2 == 0)?'odd':'';?>">
                    ...
                    <td class="center" width="30"><input id="check<?php echo $i;?>" name="check<?php echo $i;?>" class="checkbox" type="checkbox" value="<?php echo $Data["firmm01_no"];?>"></td>
                    <td class="center" width="30">
                    	<div align="center" class="block blue">
                        	<a class="edit" onClick="SetKey(<?php echo $Data["firmm01_no"];?>);EventClick('Alter')"></a>
                        </div>
                    </td>                    
                    <td class="center"><?php echo ($Data["firmm01_type1"] == 'C'?'公司':'個人');?></td>
                    <td class="left"><?php echo $Data["firmm01_nm"];?></td>
                    <td class="center"><?php echo $Data["firmm01_nicknm"];?></td>
                </tr>
                <?php }?>                               
            </table>
			</form>            
