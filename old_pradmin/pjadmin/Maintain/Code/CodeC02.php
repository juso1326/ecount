	...
	function EventClick(event){
		switch (event){
			...
			case 'Del':
				...
				break;
			case 'Setting':
				$('#KeyForm').attr('action','CodeC02.php')
				$('#KeyForm').submit();
				break;			
				break;
			default:
        ...
        <div class="box-content">
            <div class="box-head">
            	<ul class="btn">
                    ...
                    <li style="padding:0 10px;">
                    	第
						<select onChange="javascript:window.location='CodeC02.php?page=' + this.value">
        	...
        	<table class="table-bordered">
            	...
            	<tr class="<?php echo ($i%2 == 0)?'odd':'';?>">
                    ...
                    <td class="center" width="30"><input id="check<?php echo $i;?>" name="check<?php echo $i;?>" class="checkbox" type="checkbox" value="<?php echo $Data["C02_no"];?>"></td>
                    <td class="center" width="30">
                    	<div align="center" class="block blue">
                        	<a class="edit" onClick="SetKey(<?php echo $Data[0];?>);EventClick('Alter')"></a>
                        </div>
                    </td>                    
                	<td><?php echo $Data["C02_nm"];?></td>
                </tr>
                <?php }?>                               
            </table>
			</form>            
