...
<script>
	function ChkForm(form){
		if(empty(form.C04_nm.value,'給付名稱')){
		}else{
			form.submit()
		}
	}
            ...
            <div class="box-content">
                ...
                <div class="box-data">
                        ...
                        <form id="form1" name="form1" method="post" action="Code_AlterNew.php">
                        	...
                        	<input id="C04_no" name="C04_no" type="hidden" value="<?php echo $init["C04_no"];?>">
                        	<table class="table-input">
                            	<tr>
                                	<td><em>*</em>給付名稱</td>
                                	<td><input type="text" id="C04_nm" name="C04_nm" size="30" maxlength="20" value="<?php echo $init["C04_nm"]?>"></td>
                                </tr>
                            </table>
						</form>
                        </div>
