...
<script>
	function ChkForm(form){
		if(empty(form.C02_nm.value,'類型名稱')){
		}else{
			form.submit()
		}
	}
            ...
            <div class="box-content">
                ...
                <div class="box-data">
                        ...
                        <form id="form1" name="form1" method="post" action="Code_AlterNew.php">
                        	...
                        	<input id="C02_no" name="C02_no" type="hidden" value="<?php echo $init["C02_no"];?>">
                        	<table class="table-input">
                            	<tr>
                                	<td><em>*</em>類型名稱</td>
                                	<td><input type="text" id="C02_nm" name="C02_nm" size="30" maxlength="20" value="<?php echo $init["C02_nm"]?>"></td>
                                </tr>
                            </table>
						</form>
                        </div>
