				...
				if($('resu',xml).text() == '1'){
					...
					switch(obj.value){
						...
						case 'P':
							...
							$('#paym01_discountTax')
							.append($('<option>', { value : '.14', selected : 'selected'}).text('14%（具發票）'))	
							.append($('<option>', { value : '.07'}).text('7%（公基金）'));	
	...
	function TaxList(){
		...
		switch (T1){
			case 'P':
				...
				//.append($('<option value=".07" ' + (_paym01_discountTax == '.07' ? 'selected' : '') + '>').text('7'))
			...
			case 'C':
				...
				//2017制度更改
				$('#paym01_discountTax')
				.append($('<option value=".14" ' + (_paym01_discountTax == '.14' ? 'selected' : '') + '>').text('14'))
				.append($('<option value=".09" ' + (_paym01_discountTax == '.09' ? 'selected' : '') + '>').text('9'))
				.append($('<option value=".07" ' + (_paym01_discountTax == '.07' ? 'selected' : '') + '>').text('7'))
				.append($('<option value="0" ' + (_paym01_discountTax == '0' ? 'selected' : '') + '>').text('0'));
				break;
			case 'C1':
				...
				//2017制度更改
				$('#paym01_discountTax')
				.append($('<option value=".14" ' + (_paym01_discountTax == '.14' ? 'selected' : '') + '>').text('14%（具發票）'))
				.append($('<option value=".07" ' + (_paym01_discountTax == '.07' ? 'selected' : '') + '>').text('7%（公基金）'));
				break;
			default:
				T1Per = 0
				break;
	...
	function GetTotal(){
		...
		switch (T1){
			...
			case 'C':
				$("#paym01_discountTax").find('option').remove();
				//2017制度更改
				$('#paym01_discountTax').append($('<option>', { value : '.14', selected : 'selected'}).text('14%（具發票）'))
				//.append($('<option value=".09" ' + (_paym01_discountTax == '.09' ? 'selected' : '') + '>').text('9'))
				.append($('<option value=".07" ' + (_paym01_discountTax == '.07' ? 'selected' : '') + '>').text('7%（公基金）'))
				//.append($('<option value="0" ' + (_paym01_discountTax == '0' ? 'selected' : '') + '>').text('0'));
