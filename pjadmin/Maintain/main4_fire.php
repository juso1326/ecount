...
*/
	$Sql = "
		SELECT pt02.* 
		, cm01.comm01_nicknm ,cm01.comm01_quid
...
<div class="side-content">
	...
	<div class="box">
        <div class="box-content">
            <div class="box-head">
            	<ul class="btn">
                    <?php if($sT == "M"){?><li><a title="+加/扣項" href="main4_fix.php?DataKey=<?php echo $sMem;?>" rel="shadowbox;width=600;height=400" ><input class="green" type="button" value="+加/扣項" ></li></a><?php }?>
                	<li>
                    	<select id="sT" name="sT" onChange="Sreach()">
                        	<option value="M">個人入帳紀錄</option>
							<?php if($LevelMem == "1" || $LevelMem == "2"){?><option value="T" >薪資總表</option><?php }?>                            
                        	<?php if($LevelMem == "1" || $LevelMem == "2"){?><option value="F" selected>支付廠商記錄</option><?php }?>                            
                        </select>
                    </li>                                       
                </ul>
            </div>
            <?php if($LevelMem == "1" || $LevelMem == "2"){?>   
        	...
        	<table class="table-bordered" id="FTable">
            	<tr>              
                	<td colspan="11" align="left" >
                        <div style="margin-left:20px;">                    
                            ...
                            月 
                            <span style=" margin-left:15px;"><a class="next" href="main4_fire.php?<?php echo YearMonthPN('N',$sY,$sM);?>"></a></span>  
                        </div>                                                
                    </td>
                </tr>
            	<tr class="title">
            	...
            	<tr class="<?php echo ($i%2 == 0)?'odd':'';?>"> 
                    ...
                    <td class="center"><?php echo '('.$Data["comt02_bankId"] . ')' . $Data["comt02_bank"];?></td>
                    <td class="center"><?php echo $Data["comt02_branch"];?></td>
                    <td class="center"><?php echo $Data["comt02_acc"];?></td>
