        ...
        <div class="box-content">
        	...
        	<table class="table-bordered">
            	<tr class="title">
                    ...
                    <td class="center" width="30">設定</td>
                	<td class="center" width="150">群組名稱</td>
                	<td class="left" width="50">是否開啟</td>
                </tr>
                <?php 
				$i = 0;
            	...
            	<tr class="<?php echo ($i%2 == 0)?'odd':'';?>">
                    ...
                    <td class="center" width="30">
                    	<div align="center" class="block black">
                        	<a class="Setting" onClick="SetKey(<?php echo $Data[0];?>);EventClick('Setting')"></a>
                        </div>                    
                    </td>                    
                	<td><?php echo $Data[1];?></td>
                	<td><?php echo ($Data[2] == 'Y')?'是':'否';?></td>
                </tr>
                <?php }?>                               
            </table>
			</form>            
