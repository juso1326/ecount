...
//參數
	...
	$Sql = " 
		Select memm01_no, memm01_nm, memm01_nick, memm01_loginid, memm01_pwd, memm01_open
		From mem_m01 
	";
        ...
        <div class="box-content">
        	...
        	<table class="table-bordered">
            	<tr class="title">
                    ...
                    <td class="center" width="30">姓名</td>
                	<td class="center" width="50">暱稱</td>
                	<td class="left" width="50">帳號</td>
                	<td class="left" width="50">是否在職</td>                    
                </tr>
                <?php 
				$i = 0;
            	...
            	<tr class="<?php echo ($i%2 == 0)?'odd':'';?>">
                    <td class="center" width="30"><input id="check<?php echo $i;?>" name="check<?php echo $i;?>" class="checkbox" type="checkbox" value="<?php echo $Data[0];?>"></td>                    
                    <td class="center" width="30">
                    	<div align="center" class="block blue">
                        	<a class="edit" onClick="SetKey(<?php echo $Data[0];?>);EventClick('Alter')"></a>
                        </div>
                    </td>                   
                    <td><?php echo $Data["memm01_nm"];?></td>
                	<td class="center" width="50"><?php echo $Data["memm01_nick"];?></td>
                	<td class="left" width="50"><?php echo $Data["memm01_loginid"];?></td>
                	<td class="left" width="50"><?php echo $Data["memm01_open"];?></td> 
                </tr>
                <?php }?>                               
            </table>
			</form>            
