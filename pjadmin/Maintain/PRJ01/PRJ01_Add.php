            ...
            <div class="box-content">
                <div class="box-head">
                    <ul class="btn">
                        ...
                        <li><input class="gray" type="button" value="Return" onClick="window.location='<?php echo $GetFileCode;?>.php?PageCon=<?php echo $PageCon;?>'" ></li>
                    </ul>
                </div>
                ...
                <div class="box-data">
			            ...
			            <input id="PageCon" name="PageCon" type="hidden" value="<?php echo $PageCon;?>">
                        	<table class="table-input">
                            	<tr>
                                	<td><em>*</em>開案日期</td>
                                	<td><input type="text" id="prjm01_startDate" name="prjm01_startDate" size="8" maxlength="8" class="datepicker" value="<?php echo DspDate(date('Ymd'));?>"></td>
                                </tr>                            
                            	<tr>
                                	<td><em>*</em>專案名稱</td>
                                	<td><input type="text" id="prjm01_nm" name="prjm01_nm" size="60" maxlength="50"></td>
                                </tr>                            
                            	<tr>
                                	<td>專案類型</td>
                                	<td>
                                    	<select id="c02_no" name="c02_no" class="chosen-select w200" data-placeholder="..." >
                                            ...
                                            <option value="<?php echo $C02["C02_no"]?>"><?php echo $C02["C02_nm"]?></option>
                                            <?php }?>
                                        </select>
                                    </td>
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<select id="comm01_no" name="comm01_no" class="chosen-select w300" data-placeholder="..." >
                                            ...
                                            <option value="<?php echo $comm01["comm01_no"]?>"><?php echo $comm01["comm01_nicknm"]?></option>
                                            <?php }?>
                                        </select>
                                    </td>                                
                                </tr> 
                            	<tr>
                                	<td>報價單號</td>
                                	<td><input type="text" id="prjm01_Quoid" name="prjm01_Quoid" size="50" maxlength="30"></td>                               
                                </tr>
                            	<tr>
                                	<td>總額</td>
                                	<td><input type="text" id="prjm01_totalmoney" name="prjm01_totalmoney" size="20" maxlength="20" value="0"><small>請填寫含稅總額</small></td>
                                </tr>   
                                <tr>
                                	<td>專案負責人</td>
                                    <td>
                                    	<Select id="memm01_no" name="memm01_no">
                                        	...
                                        	<option value="<?php echo $mem["memm01_no"];?>"<?php echo ($mem["memm01_no"] == $_SESSION["MemNO"])?" selected":"";?>><?php echo $mem["memm01_nick"];?></option>
                                            <?php }?>
                                        </Select>
                                    </td>
                                </tr>                                                              
